...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                intent.putExtra("name", barangList.get(position).getName());
                intent.putExtra("harga", barangList.get(position).getHarga());
                ...
                intent.putExtra("tanggal", barangList.get(position).getTanggal());
            ...
            public void onLoveClick(View view, int position) {
                ...
                final int id = barangList.get(position).getId();
                final Boolean love = barangList.get(position).getLove();
                final ImageView mLove = view.findViewById(R.id.love);

                if (love){
                    mLove.setImageResource(R.drawable.likeof);
                    barangList.get(position).setLove(false);
                    updateLove("update_love", id, false);
                    adapter.notifyDataSetChanged();
                } else {
                    mLove.setImageResource(R.drawable.likeon);
                    barangList.get(position).setLove(true);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("Search Baran...");
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        Call<Barang> call = apiInterface.updateLove(key, id, love);
