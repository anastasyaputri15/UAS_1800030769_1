...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mName.setText(barang.get(position).getName());
        holder.mType.setText(barang.get(position).getJumlah() + " / "
                + barang.get(position).getHarga());
        holder.mDate.setText(barang.get(position).getTanggal());
        ...
        final Boolean love = barang.get(position).getLove();
    ...
    public Filter getFilter() {
        if (filter==null) {
            filter=new CustomFilter((ArrayList<Barang>) barangFilter,this);
